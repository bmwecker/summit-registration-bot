...
1. Откройте письмо/сообщение со ссылкой и кликните по ссылке (начинается с https://zoom.us/j/... или https://us02web.zoom.us/...).
...
1. Open the email/message with the link and click on it (starts with https://zoom.us/j/...).
...
1. פתח את האימייל/הודעה עם הקישור ולחץ עליו (מתחיל ב-https://zoom.us/j/...).
